...
export default function Translator() {
  ...
  const [outputFormat, setOutputFormat] = useState('sw')
  ...
  const handleTranslate = async () => {
    ...
    const options = {
      ...
      headers: {
        ...
        'X-RapidAPI-Key': 'e449f5b9afmsh36dddb74da1809fp1bcbe6jsn2191c1b88b5d',
    ...
    try {
      ...
      console.log(error)
      alert('Wewe jaribu mashida ni mengi sana')
    }
